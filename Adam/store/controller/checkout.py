...
def placeorder(request):
    if request.method == 'POST':
        ...
        trackid = 'adamdich'+str(random.randint(1111111,9999999))
        while Order.objects.filter(tracking_id=trackid) is None:
            trackid = 'adamdich'+str(random.randint(1111111,9999999))
        neworder.tracking_id = trackid
        neworder.save()
        ...
        for item in neworderitems:
            ...
            #To decrease from available stock
